...
public class ScatterDataSet extends LineScatterCandleRadarDataSet<Entry> implements IScatterDataSet {
    ...
    public void setAttachedToLineDataSet(boolean attachedToLineDataSet) {
        this.mAttachedToLineDataSet = attachedToLineDataSet;
        if (attachedToLineDataSet) {
