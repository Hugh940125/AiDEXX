...
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
    ...
    protected List<Float> mGradientPositions = null;
    ...
    @Override
    public List<Float> getGradientPositions() { return mGradientPositions; }
    ...
    public void setGradientPositions(List<Float> gradientPositions) { this.mGradientPositions = gradientPositions; }
    ...
    public int getIndexInEntries(int xIndex) {
        ...
        for (int i = 0; i < getEntryCount(); i++) {
            Entry entry = getEntryForIndex(i);
