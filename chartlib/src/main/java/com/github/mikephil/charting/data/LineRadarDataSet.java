...
public abstract class LineRadarDataSet<T extends Entry> extends LineScatterCandleRadarDataSet<T> implements ILineRadarDataSet<T> {
    ...
    public void setFillColors(int... fillColors) {
        this.mFillColors = ColorTemplate.createColors(fillColors);
    }

    public List<Float> getFillGradientPositions() {
        return mFillGradientPositions;
    }

    public void setFillGradientPositions(List<Float> fillGradientPositions) {
        this.mFillGradientPositions = fillGradientPositions;
    }
