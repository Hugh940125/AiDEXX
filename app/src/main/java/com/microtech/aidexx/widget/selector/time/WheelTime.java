...
import com.microtech.aidexx.widget.selector.base.ArrayWheelAdapter;
    ...
    private void setSolar(int year, final int month, int day, int h, int m, int s) {
        ...
        wv_year.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                if (wv_year.getCurrentItem() + startYear == endYear && wv_month.getCurrentItem() + 1 == endMonth && wv_day.getCurrentItem() + 1 == endDay) {
                    wv_hours.setAdapter(new NumericWheelAdapter(0, endHour));
                ...
                if (wv_year.getCurrentItem() + startYear == endYear && wv_month.getCurrentItem() + 1 == endMonth && wv_day.getCurrentItem() + 1 == endDay && wv_hours.getCurrentItem() == endHour) {
                    wv_minutes.setAdapter(new NumericWheelAdapter(0, endMinute));
                    wv_minutes.setCurrentItem(endMinute);
                } else {
                    wv_minutes.setAdapter(new NumericWheelAdapter(0, 59));
                    wv_minutes.setCurrentItem(30);
                }
        ...
        wv_hours.setOnItemSelectedListener(index -> {
            if (wv_year.getCurrentItem() + startYear == endYear && wv_month.getCurrentItem() + 1 == endMonth && wv_day.getCurrentItem() + 1 == endDay && index == endHour) {
                wv_minutes.setAdapter(new NumericWheelAdapter(0, endMinute));
                wv_minutes.setCurrentItem(endMinute);
            } else {
                wv_minutes.setAdapter(new NumericWheelAdapter(0, 59));
