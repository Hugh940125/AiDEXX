package com.microtech.aidexx.widget.selector.option;
...
import com.microtech.aidexx.widget.selector.base.BasePickerView;
import com.microtech.aidexx.widget.selector.base.PickerOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(mPickerOptions.textContentConfirm) ? context.getResources().getString(R.string.confirm_yes) : mPickerOptions.textContentConfirm);
