package com.microtech.aidexx.widget.text;
        ...
        for (int i = firstLine; i <= lastLine; i++) {
            ...
            if (align == Layout.Alignment.ALIGN_NORMAL) {
                if (dir == DIR_LEFT_TO_RIGHT) {
                    indentWidth = getIndentAdjust(i, Layout.Alignment.ALIGN_NORMAL);
                    x = left;
                } else {
                    indentWidth = -getIndentAdjust(i, Layout.Alignment.ALIGN_OPPOSITE);
                    x = right;
                }
            } else {
                indentWidth = 0;
