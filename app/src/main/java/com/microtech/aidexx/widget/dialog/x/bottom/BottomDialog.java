...
import com.microtech.aidexx.widget.dialog.x.DialogXStyle;
import com.microtech.aidexx.widget.dialog.x.ObjectRunnable;
import com.microtech.aidexx.widget.dialog.x.info.TextInfo;
import com.microtech.aidexx.widget.dialog.x.interfaces.BottomDialogSlideEventLifecycleCallback;
import com.microtech.aidexx.widget.dialog.x.interfaces.DialogConvertViewInterface;
import com.microtech.aidexx.widget.dialog.x.interfaces.DialogLifecycleCallback;
import com.microtech.aidexx.widget.dialog.x.interfaces.DialogXAnimInterface;
import com.microtech.aidexx.widget.dialog.x.interfaces.OnBackPressedListener;
import com.microtech.aidexx.widget.dialog.x.interfaces.OnBackgroundMaskClickListener;
import com.microtech.aidexx.widget.dialog.x.interfaces.OnBindView;
import com.microtech.aidexx.widget.dialog.x.interfaces.OnDialogButtonClickListener;
import com.microtech.aidexx.widget.dialog.x.interfaces.ScrollController;
import com.microtech.aidexx.widget.dialog.x.util.BottomDialogTouchEventInterceptor;
import com.microtech.aidexx.widget.dialog.x.views.BlurView;
import com.microtech.aidexx.widget.dialog.x.views.BottomDialogScrollView;
import com.microtech.aidexx.widget.dialog.x.views.DialogXBaseRelativeLayout;
import com.microtech.aidexx.widget.dialog.x.views.MaxRelativeLayout;
