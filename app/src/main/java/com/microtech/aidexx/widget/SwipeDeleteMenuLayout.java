...
public class SwipeDeleteMenuLayout extends ViewGroup {
    ...
    public SwipeDeleteMenuLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeDeleteMenuLayout(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param ios
     */
    public SwipeDeleteMenuLayout setIos(boolean ios) {
        isIos = ios;
        return this;
    }
     ...
     * @return
     */
    public SwipeDeleteMenuLayout setLeftSwipe(boolean leftSwipe) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //左滑右滑的开关,默认左滑打开菜单
        isLeftSwipe = true;
        TypedArray ta = context.getTheme().obtainStyledAttributes(attrs, com.mcxtzhang.swipemenulib.R.styleable.SwipeMenuLayout, defStyleAttr, 0);
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        ...
        invalidate();*/
        //展开就加入ViewCache：
        mViewCache = SwipeDeleteMenuLayout.this;
...
/*        mScroller.startScroll(getScrollX(), 0, -getScrollX(), 0);
    ...
    protected void onDetachedFromWindow() {
        if (this == mViewCache && mViewCache.isExpand) {
            mViewCache.smoothClose();
            mViewCache = null;
        }
