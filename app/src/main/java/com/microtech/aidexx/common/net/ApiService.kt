...
const val API_HISTORY_DEVICE = "$middleUrl/cgmDevice/getUserDeviceHistory" //注销设备
...
interface ApiService {
    ...
    @GET(API_HISTORY_DEVICE)
    suspend fun getHistoryDevice(): ApiResult<BaseResponse<List<HistoryDeviceInfo>>>
