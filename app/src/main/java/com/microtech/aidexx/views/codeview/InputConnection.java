...
public class InputConnection extends InputConnectionWrapper {
     ...
     *
     * @param target  the {@link android.view.inputmethod.InputConnection} to be proxied.
     * @param mutable set {@code true} to protect this object from being reconfigured to target
     *                another {@link android.view.inputmethod.InputConnection}.  Note that this is ignored while the target is {@code null}.
     */
    public InputConnection(android.view.inputmethod.InputConnection target, boolean mutable) {
